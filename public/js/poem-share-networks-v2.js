(() => {
  ...
  function enhance(root) {
    ...
    // Pinterest requires a public raster image URL. The site exposes a complete
    // poem card as SVG; wsrv.nl rasterises it to PNG for Pinterest without
    // changing the canonical destination URL.
