(() => {
  ...
  function enhance(button) {
    ...
    const socialSvg = `https://www.aupositeur.be/social/citations/${encodeURIComponent(slug)}.svg?v=20260912-1`;
